            ...
            private static void createAndShowAvailableSeatsGUI(String username, String transport) {
                ...
                payButton.addActionListener(e -> {
                    ...
                    if (result == JOptionPane.YES_OPTION) {
                        // Redirect to the payment gateway's URL
                        String paymentGatewayUrl = "https://www.paypal.com/in/home"; // Replace with actual payment gateway URL
                        try {
                            // Open the payment gateway URL in the default web browser
                            Desktop.getDesktop().browse(new URI(paymentGatewayUrl));
